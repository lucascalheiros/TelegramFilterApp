...
class MainActivityTest {
    ...
    fun `on start up non Ready AuthorizationSet will show setup screen`() = runTest {
        ...
        composeTestRule.onNodeWithText(context.getString(R.string.telegram_account_setup)).assertIsDisplayed()
    }
    ...
    fun `on start up Ready AuthorizationSet will show filter list`() = runTest {
        ...
        composeTestRule.onNodeWithText(context.getString(R.string.filters)).assertIsDisplayed()
    }
